...
-- Admin bildirim kutusu (vardiya kapanınca otomatik dolar).
...
-- notifications: sadece adminler okur / okundu işaretler.
-- INSERT için politika yok; kayıtları security definer tetikleyici açar.
...
-- Bildirimleri canlı (realtime) almak için yayına ekle.
